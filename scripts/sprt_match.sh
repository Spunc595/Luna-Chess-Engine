...
# `sprt`: SPRT elo0=0 elo1=10 alpha=beta=0.05, capped by rounds*2 games (12,000 games = 6000 rounds).
...
SPRT=""
if [ "$MODE" = "sprt" ]; then SPRT="-sprt elo0=0 elo1=10 alpha=0.05 beta=0.05"; fi
echo "adjudication: -draw movenumber=40 movecount=6 score=10 -resign movecount=4 score=600 (identical for every match of the plan); tc=10+0.1; concurrency 2; Hash 64; Threads 1; openings 8moves_v3.pgn order=random" > "$OUT/params.txt"
